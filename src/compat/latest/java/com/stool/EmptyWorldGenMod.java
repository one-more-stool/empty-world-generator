...
public class EmptyWorldGenMod implements ModInitializer {
    ...
    public static final Identifier EMPTY_WORLD_CHUNK_GENERATOR_ID = Identifier.of(MOD_ID, "empty_world");

    @Override
    public void onInitialize() {
        Registry.register(Registries.CHUNK_GENERATOR, EMPTY_WORLD_CHUNK_GENERATOR_ID, EmptyWorldChunkGenerator.CODEC);
